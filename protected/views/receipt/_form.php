...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'receipts_date'); ?>
		<?php echo $form->textField($model,'receipts_date',array('size'=>10,'maxlength'=>10)); ?>
		<?php echo $form->error($model,'receipts_date'); ?>
	</div>
